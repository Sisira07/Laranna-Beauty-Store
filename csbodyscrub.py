...
#Photoslider
pics_list=['bodyscrub1.jpg', 'bodyscrub.jpg','bodyscrub2.jpg']
...
bshead=Image.open('bshead.png')
bstk=ImageTk.PhotoImage(bshead)
bslab=Label(my_frame, image=bstk, bd=0, highlightthickness=0)
bslab.place(x=535,y=120)
...
price_label=Label(my_frame, text='$35.00', font=('Microsoft Yahei UI Light', 22,'bold'), bg='white', fg='black')
...
insert_text= """
- Encourages the rejuvenation of skin

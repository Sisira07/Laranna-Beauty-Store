...
MenuBttn5=Button(my_frame, text = "  CAREERS  ", font=('Times New roman',12),relief = RAISED,
                      bg='dark slate blue',fg='white',activebackground='darkslateblue',
                      activeforeground='lavender',bd=0,cursor='hand2', command=finalbill)
...
#Photoslider
pics_list=['moist.jpg', 'moist3.jpg','moist1.jpg']
...
mohead=Image.open('mohead.png')
motk=ImageTk.PhotoImage(mohead)
molab=Label(my_frame, image=motk, bd=0, highlightthickness=0)
molab.place(x=550,y=120)
...
price_label=Label(my_frame, text='$20.00', font=('Microsoft Yahei UI Light', 22,'bold'), bg='white', fg='black')
...
create_button= Button(my_frame, text='CREATE YOUR FORMULA', font=('Times new roman', 20), bg='black' , fg='white', activebackground='black',
                      activeforeground='white',width=26,cursor='hand2')

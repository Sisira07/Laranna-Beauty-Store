...
#Photoslider
pics_list=['hairmask4.jpg','hairmask.jpg','hairmask2.jpg','hairmask3.jpg']
...
insert_text2= """
- Improves overall hair health + helps address damage
...
hming=Image.open('hming.png')
rhming=hming.resize((497,170))
tkhming=ImageTk.PhotoImage(rhming)
labeling= Label(my_frame, image=tkhming, bg='white', fg='black')

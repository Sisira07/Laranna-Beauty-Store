...
#Photoslider
pics_list=['bodylotion.jpg','bodylotion2.jpg','cbw3.jpg']
...
blhead=Image.open('blhead.png')
bltk=ImageTk.PhotoImage(blhead)
bllab=Label(my_frame, image=bltk, bd=0, highlightthickness=0)
bllab.place(x=535,y=120)

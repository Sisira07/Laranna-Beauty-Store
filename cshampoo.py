...
#Photoslider
pics_list=['shampoo.jpeg', "shampoo1.jpg","shampoo2.jpg", "shampoo3.jpg"]
...
cshamhead=Image.open('cshamhead.png')
cshamtk=ImageTk.PhotoImage(cshamhead)
cshamlab=Label(my_frame, image=cshamtk, bd=0, highlightthickness=0)
cshamlab.place(x=530,y=120)
...
create_button= Button(my_frame, text='CREATE YOUR FORMULA', font=('Times new roman', 20), bg='black' , fg='white', activebackground='black',
                      activeforeground='white',width=26,cursor='hand2',command=hquiz)
...
insert_text= """
      - Improves shine, smoothness and manageability when used \n with your Custom Conditioner.
      
- Gently dissolves daily impurities, product build up,dirt
    and excess oil.
    
- Draws in additional moisture, improving elasticity and
    reducing breakage.
"""
...
shaming=Image.open('shaming.png')
rshaming=shaming.resize((464,210))
tkshaming=ImageTk.PhotoImage(rshaming)
labeling= Label(my_frame, image=tkshaming, bg='white', fg='black')
labeling.place(x=710,y=650)

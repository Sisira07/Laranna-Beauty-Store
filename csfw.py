...
#Photoslider
pics_list=['facewash2.jpg', 'facewash.jpg','facewash3.jpg']
...
price_label=Label(my_frame, text='$20.00', font=('Microsoft Yahei UI Light', 22,'bold'), bg='white', fg='black', autostyle=False)

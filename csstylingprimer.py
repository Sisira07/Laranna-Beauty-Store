...
#Photoslider
pics_list=['stypri.jpg','stypri1.jpg','stypri2.jpg']
...
sphead=Image.open('sphead.png')
sptk=ImageTk.PhotoImage(sphead)
splab=Label(my_frame, image=sptk, bd=0, highlightthickness=0)
splab.place(x=550,y=120)
...
insert_text= """
- Customized with your unique goals to help
achieve any style you desire with ease.
...
color from fading or shifting, and defends
against UV and environmental aggressors.
...
sping=Image.open('sping.png')
rsping=sping.resize((476,210))
tksping=ImageTk.PhotoImage(rsping)
labeling= Label(my_frame, image=tksping, bg='white', fg='black')

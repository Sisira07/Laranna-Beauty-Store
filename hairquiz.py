...
def update_selected_count():                                        #dealing with checkboxes----disabling after 4 selections
...
def show_ingredients():                     
    ...
    #next button
    final=Button(window, text="NEXT",font=('Georgia', 24), bd=0,width=10, fg="white", bg="black", activebackground="black", activeforeground="black", command=finalpg)
    final.place(x=970, y=560)
...
def shamcart():
    ...
    if mbox:
        ...
        if quantity_combo1.get()=='16oz':
            ...
            q=16
            p=27
            product_data.insert_product('Shampoo', q , p)
...
def condcart():
    ...
    if mbox2:
        ...
        if quantity_combo2.get()=='16oz':
            ...
            q=16
            p=27
            product_data.insert_product('Conditioner', q , p)
...
def secart():
    ...
    if mbox3:
        ...
        if quantity_combo3.get()=='5oz':
            ...
            q=5
            p=31
            product_data.insert_product('Hair Serum', q , p)
...
def mcart():
    ...
    if mbox4:
        ...
        if quantity_combo4.get()=='5oz':
            ...
            q=5
            p=20
            product_data.insert_product('Hair Mask', q , p)
...
def spcart():
    ...
    if mbox5:
        ...
        if quantity_combo5.get()=='4oz':
            ...
            q=4
            p=24
            product_data.insert_product('Styling Primer', q , p)
...
def finalpg():
    ...
    #-------------------------------F I N A L     P A G E------------------------------------------
    final_big=Frame(window, width=1000, height=500, bg="#eae9f1")
    ...
    resize_bgImage20=bg20.resize((950, 450))
    ...
    label_s2=Label(final_s,width=200, height=300)
    label_s2.place(x=60, y=170)

    #1 add to basket button
    add_to_basket=Button(final_s, text="ADD TO BASKET",font=('Georgia', 25), bd=0,
                         width=15, fg="white", bg="black", activebackground="black", activeforeground="black", command=shamcart)
    add_to_basket.place(x=540, y=385)
    
    #price label
    price_label1=Label(final_s, text='$21.00', font=('Microsoft Yahei UI Light', 20,'bold'), bg='#caebda', fg='black')
    price_label1.place(x=905, y=55)
    ...
    for i in range(len(frag)):
        ...
        frag_button.place(x=580, y=165 + i*55, width=230, height=40)
    shampoo_final()
    #---------------------------final_c--------------------------------------------------------------------------------------------------------------------
    #final_c
    ...
    label_c2=Label(final_c,width=200, height=300)
    label_c2.place(x=60, y=160)

    #2 add to basket button
    add_to_basket2=Button(final_c, text="ADD TO BASKET",font=('Georgia', 25), bd=0, width=14, fg="white",
                          bg="black", activebackground="black", activeforeground="black", command=condcart)
    add_to_basket2.place(x=569, y=375)
    
    #price label
    price_label2=Label(final_c, text='$21.00', font=('Microsoft Yahei UI Light', 20,'bold'), bg='#caebda', fg='black')
    ...
    for i in range(len(frag)):
        ...
        frag_button.place(x=580, y=155 + i*55, width=230, height=40)
    conditioner_final()
    ...
    label_se2=Label(final_se,width=200, height=300)
    label_se2.place(x=60, y=174)

    #3 add to basket button
    add_to_basket3=Button(final_se, text="ADD TO BASKET",
                          font=('Georgia', 25), bd=0, width=15,
                          fg="white", bg="black", activebackground="black", activeforeground="black", command=secart)
    add_to_basket3.place(x=548, y=378)
    
    #price label
    price_label3=Label(final_se, text='$29.00', font=('Microsoft Yahei UI Light', 20,'bold'), bg='#caebda', fg='black')
    price_label3.place(x=905, y=49)
    ...
    label_m2.place(x=60, y=190)

    #4 add to basket button
    add_to_basket4=Button(final_m, text="ADD TO BASKET",font=('Georgia', 25), bd=0, width=14,
                          fg="white", bg="black", activebackground="black", activeforeground="black", command=mcart)
    add_to_basket4.place(x=543, y=382)
    
    #price label
    price_label4=Label(final_m, text='$20.00', font=('Microsoft Yahei UI Light', 20,'bold'), bg='#caebda', fg='black')
    price_label4.place(x=905, y=51)
    ...
    for i in range(len(frag)):
        ...
        frag_button.place(x=580, y=162 + i*55, width=240, height=40)
    mask_final()

    #-----------------------------final_px------------------------------------------------------------------------------------------------------------------
    global final_p, p_bgImage, label_p2, price_label5, quantity_combo5
    #final_m
    final_p=Frame(final_big, width=1000, height=550, bg="#eae9f1")
    #final_se.pack()

    bg16=Image.open("trial_p.png")
    resize_bgImage16=bg16.resize((950, 450))
    p_bgImage= ImageTk.PhotoImage(resize_bgImage16)
    #label_p1
    label_p1=Label(final_p, image=p_bgImage, bg="#eae9f1")
    label_p1.image=p_bgImage
    label_p1.place(x=0, y=0)
    label_p2=Label(final_p,width=200, height=300, bg="#eae9f1" )
    label_p2.place(x=60, y=171)

    #5 add to basket button
    add_to_basket5=Button(final_p, text="ADD TO BASKET",font=('Georgia', 25), bd=0, width=14, fg="white",
                         bg="black", activebackground="black", activeforeground="black", command=spcart)
    add_to_basket5.place(x=548, y=378)
    
    #price label
    price_label5=Label(final_p, text='$24.00', font=('Microsoft Yahei UI Light', 20,'bold'), bg='#caebda', fg='black')
    price_label5.place(x=905, y=50)
    ...
    qty5=OptionMenu(final_p, quantity_combo5, *quantity5,command=click_bind5)
    ...
    for i in range(len(frag)):
        ...
        frag_button.place(x=580, y=160 + i*55, width=240, height=40)
    primer_final()
...
#product_frame_current.pack_forget()
#label1
label_s1=Label(frame_s, text=("Choose colour for your Shampoo"), font=('Georgia', 24), bg="#e3e3ef")
...
#label1
label_c1=Label(frame_c, text=("Choose colour for your Conditioner"), font=('Georgia', 24), bg="#e3e3ef")
...
label_se1=Label(frame_se, text=("Select your Hair Serum: "), font=('Georgia', 24), bg="#e3e3ef")
...
#label1
label_m1=Label(frame_m, text=("Choose colour for your Hair Mask"), font=('Georgia', 24), bg="#e3e3ef")
...
#label1
label1=Label(frame1, text="What is your natural hair type?", font=('Georgia', 24), bg="#e3e3ef")
...
#label1
label1=Label(frame2, text=" What is troubling you about your hair?", font=('Georgia', 24), bg="#e3e3ef")
label1.config(anchor=CENTER)
...
#label1
label1=Label(frame3, text="How often do you wash your hair?", font=('Georgia', 24), bg="#e3e3ef")
label1.config(anchor=CENTER)
label1.grid(row=4, column=0, padx=100, pady=15)
...
#label1
label1=Label(frame4, text="Select your #hairgoals   (any 4)", font=('Georgia', 24), bg="#e3e3ef")
label1.config(anchor=CENTER)
label1.pack()
...
#label1
label1=Label(frame5, text="Which colour best describes your hair?", font=('Georgia', 24), bg="#e3e3ef")
label1.config(anchor=CENTER)
label1.grid(row=4, column=0, padx=100, pady=15)
...
label1=Label(frame10, text="Select your desired hair products:", font=('Georgia', 24), bg="#e3e3ef")
label1.config(anchor=CENTER)
label1.pack()
...
#label1
label1=Label(frame6, text=" Choose your formula colour....", font=('Georgia', 24), bg="#e3e3ef")
label1.config(anchor=CENTER)
...
show_result=Button(window, text="SHOW RESULTS", cursor='hand2', bg="black", bd=0, width=13
             ,  activebackground='black', activeforeground='black',fg="white", font=('Georgia', 23), command=show_result_button)
show_result.place(x=805, y=540)

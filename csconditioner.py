...
#Photoslider
pics_list=[ "conditioner1.jpg","conditioner2.jpg", "shampoo4.jpg", 'conditioner.jpeg']
...
condhead=Image.open('condhead.png')
condtk=ImageTk.PhotoImage(condhead)
condlab=Label(my_frame, image=condtk, bd=0, highlightthickness=0)
condlab.place(x=530,y=120)
...
price_label=Label(my_frame, text='$21.00', font=('Microsoft Yahei UI Light', 22,'bold'), bg='white', fg='black')
...
when used with your Custom Shampoo.
...
label4.place(x=20,y=710, anchor='nw')

insert_text2= """
- Draws in additional moisture, improving elasticity
...
label4.place(x=730,y=600)


conding=Image.open('conding.png')
rconding=conding.resize((389,210))
tkconding=ImageTk.PhotoImage(rconding)
labeling= Label(my_frame, image=tkconding, bg='white', fg='black')
labeling.place(x=695,y=650)

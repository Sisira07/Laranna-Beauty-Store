...
#Photoslider
pics_list=['cbw1.jpg','cbw2.jpg','cbw3.jpg']
...
bwhead=Image.open('bwhead.png')
bwtk=ImageTk.PhotoImage(bwhead)
bwlab=Label(my_frame, image=bwtk, bd=0, highlightthickness=0)
bwlab.place(x=540,y=120)
...
price_label=Label(my_frame, text='$27.00', font=('Microsoft Yahei UI Light', 22,'bold'), bg='white', fg='black')
...
insert_text1= """
- Efficient method to exfoliate your skin,
along with adding smoothness

...
def click_bind(e):
    if cval.get()=='5oz                                                  ':
        price_label.config(text='$37.00')
    elif cval.get()=='3oz                                                   ':
        price_label.config(text='$29.00')
...
menu= Label(frame2,bg='dark slate blue', width=my_frame.winfo_screenwidth(),height=3, bd=0,highlightthickness=0)
...
#Photoslider
pics_list=['hairserum4.jpeg', "hairserum.jpg", "hairserum3.jpg","hairserum2.jpg"]
...
lbl_next.place(x=463,y=300)

nextImage()

#Title

hshead=Image.open('hshead.png')
hstk=ImageTk.PhotoImage(hshead)
hslab=Label(my_frame, image=hstk, bd=0, highlightthickness=0)
hslab.place(x=530,y=120)
...
price_label=Label(my_frame, text='$29.00', font=('Microsoft Yahei UI Light', 22,'bold'), bg='white', fg='black')
...
create_button= Button(my_frame, text='CREATE YOUR FORMULA', font=('Times new roman', 20), bg='black' , fg='white', activebackground='black',
                      activeforeground='white',width=26, command=hquiz)
...
insert_text1= """
- Improves shine 26x more than untreated hair.
...
insert_text2= """
- Protects hair from thermal damage up to 400°F.
    
"""
label5= Label(my_frame, text=insert_text2, font=('Georgia', 14), bg='white', fg='black')
label5.place(x=20,y=760, anchor='nw')
...
hsing=Image.open('hsing.png')
rhsing=hsing.resize((498,210))
tkhsing=ImageTk.PhotoImage(rhsing)
labeling= Label(my_frame, image=tkhsing, bg='white', fg='black')
labeling.place(x=650,y=650)
